...
namespace ProjectAPI.Infrastructure.Migrations
{
    ...
    [Migration("20260728144302_BackfillProjectMembershipsFromAssignments")]
    partial class BackfillProjectMembershipsFromAssignments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectAPI.Domain.Appointments.Entities.Appointment", b =>
                {
                    ...
                    b.HasIndex("AgentId", "AppointmentDate")
                        .IsUnique()
                        .HasDatabaseName("UX_Appointments_ActiveSlotPerAgent")
                        .HasFilter("[Status] IN ('Requested', 'Confirmed', 'RescheduleProposed') AND [AgentId] IS NOT NULL");

                    b.ToTable("Appointments", null, t =>
                        {
                            t.HasCheckConstraint("CK_Appointments_Status", "[Status] IN ('Requested', 'Confirmed', 'RescheduleProposed', 'Rejected', 'Cancelled', 'Completed', 'NoShow')");
                        });
                });
